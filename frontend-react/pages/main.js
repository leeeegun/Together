      ...
      <div id="mainpage-menu">
        ...
        <div>
          <label htmlFor="mainpage-input-area">
            <h1 className="m-3 text-3xl font-bold" style={{cursor: "pointer"}}>
              회의 참가
            </h1>
          </label>
        ...
        <div>
          <h1 className="m-3 text-3xl font-bold mainpage-title">
            회의 생성
          </h1>
          <img id="mainpage-image-3" className="mainpage-effectimg" src="./mainpage/conference.jpg" alt="conference"></img>
        </div>
        ...
        <div>
          ...
          <img id="mainpage-image-5" className="mainpage-effectimg" src="./mainpage/Descartes.png" alt="my page"></img>
        </div>

        <div>
            <h1 className="m-3 text-3xl font-bold mainpage-title" onClick={() => 
            {
